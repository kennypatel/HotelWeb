# OUTREACH DRAFT — HotelMinder
**Status:** DRAFT — not sent. Kenny writes the personal line, verifies the contact, and sends manually.

| Field | Value |
|---|---|
| Site | https://www.hotelminder.com |
| Category | Hotel management site |
| Contact page | https://www.hotelminder.com/contact |
| Submission URL | https://www.hotelminder.com/partners |
| Target page | https://anchorforhotels.com/ |
| Anchor (suggest only) | Anchor for Hotels |
| Pitch angle | List in marketplace + contribute an expert article |
