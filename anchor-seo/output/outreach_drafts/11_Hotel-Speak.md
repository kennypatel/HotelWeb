# OUTREACH DRAFT — Hotel Speak
**Status:** DRAFT — not sent. Kenny writes the personal line, verifies the contact, and sends manually.

| Field | Value |
|---|---|
| Site | https://www.hotelspeak.com |
| Category | Hotel marketing blog |
| Contact page | https://www.hotelspeak.com/contact/ |
| Submission URL | https://www.hotelspeak.com/contribute/ |
| Target page | https://anchorforhotels.com/hotel-answering-service |
| Anchor (suggest only) | hotel phone answering |
| Pitch angle | Practical guest post: the phone is still a top direct booking channel |
