# OUTREACH DRAFT — Hotel News Resource
**Status:** DRAFT — not sent. Kenny writes the personal line, verifies the contact, and sends manually.

| Field | Value |
|---|---|
| Site | https://www.hotelnewsresource.com |
| Category | Hospitality publication |
| Contact page | https://www.hotelnewsresource.com/contact.html |
| Submission URL | https://www.hotelnewsresource.com |
| Target page | https://anchorforhotels.com/ |
| Anchor (suggest only) | Anchor for Hotels |
| Pitch angle | Press release distribution + founder byline opportunity |
