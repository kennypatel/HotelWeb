# OUTREACH DRAFT — Software Advice
**Status:** DRAFT — not sent. Kenny writes the personal line, verifies the contact, and sends manually.

| Field | Value |
|---|---|
| Site | https://www.softwareadvice.com |
| Category | SaaS directory |
| Contact page | https://www.softwareadvice.com/contact/ |
| Submission URL | https://www.gartnerdigitalmarkets.com |
| Target page | https://anchorforhotels.com/ |
| Anchor (suggest only) | Anchor for Hotels |
| Pitch angle | Same Gartner vendor portal as Capterra/GetApp |
