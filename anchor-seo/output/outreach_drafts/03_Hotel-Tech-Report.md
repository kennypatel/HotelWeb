# OUTREACH DRAFT — Hotel Tech Report
**Status:** DRAFT — not sent. Kenny writes the personal line, verifies the contact, and sends manually.

| Field | Value |
|---|---|
| Site | https://hoteltechreport.com |
| Category | Hotel technology site |
| Contact page | https://hoteltechreport.com/about |
| Submission URL | https://partners.hoteltechreport.com |
| Target page | https://anchorforhotels.com/ |
| Anchor (suggest only) | Anchor for Hotels |
| Pitch angle | Create free vendor profile in Guest Messaging/Voice category; later pursue category content |
| Template to use | #3 — Directory submission (see seo-system/outreach_templates.md) |

## Opening line
[PERSONAL LINE — WRITE THIS YOURSELF after reading something they actually published]

## Body
Copy template #3 — Directory submission from seo-system/outreach_templates.md, then:
