# OUTREACH DRAFT — The Modern Hotelier
**Status:** DRAFT — not sent. Kenny writes the personal line, verifies the contact, and sends manually.

| Field | Value |
|---|---|
| Site | https://www.themodernhotelier.com |
| Category | Podcast |
| Contact page | https://www.themodernhotelier.com/contact |
| Submission URL |  |
| Target page | https://anchorforhotels.com/ |
| Anchor (suggest only) | Anchor for Hotels |
| Pitch angle | Actively books hotel tech founders |
