# OUTREACH DRAFT — Hospitality Net
**Status:** DRAFT — not sent. Kenny writes the personal line, verifies the contact, and sends manually.

| Field | Value |
|---|---|
| Site | https://www.hospitalitynet.org |
| Category | Hospitality publication |
| Contact page | https://www.hospitalitynet.org/contact |
| Submission URL | https://www.hospitalitynet.org/submit |
| Target page | https://anchorforhotels.com/ |
| Anchor (suggest only) | Anchor for Hotels |
| Pitch angle | Contributed opinion piece on missed-call revenue leakage; they accept industry expert columns |
