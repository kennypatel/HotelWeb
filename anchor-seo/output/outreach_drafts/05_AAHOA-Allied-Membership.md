# OUTREACH DRAFT — AAHOA (Allied Membership)
**Status:** DRAFT — not sent. Kenny writes the personal line, verifies the contact, and sends manually.

| Field | Value |
|---|---|
| Site | https://www.aahoa.com |
| Category | Hotel owner association |
| Contact page | https://www.aahoa.com/contact |
| Submission URL | https://www.aahoa.com/allied-members |
| Target page | https://anchorforhotels.com/ |
| Anchor (suggest only) | Anchor for Hotels |
| Pitch angle | Join as allied/vendor member -> directory listing + event access; core audience |
| Template to use | #9 — Hotel vendor listing request (see seo-system/outreach_templates.md) |

## Opening line
[PERSONAL LINE — WRITE THIS YOURSELF after reading something they actually published]

## Body
Copy template #9 — Hotel vendor listing request from seo-system/outreach_templates.md, then:
