# OUTREACH DRAFT — Hospitality Daily (Josiah Mackenzie)
**Status:** DRAFT — not sent. Kenny writes the personal line, verifies the contact, and sends manually.

| Field | Value |
|---|---|
| Site | https://www.hospitalitydaily.com |
| Category | Podcast |
| Contact page | https://www.hospitalitydaily.com |
| Submission URL |  |
| Target page | https://anchorforhotels.com/ |
| Anchor (suggest only) | Anchor for Hotels |
| Pitch angle | Short-form daily show; founder lessons on guest communication |
| Template to use | #2 — Podcast pitch (see seo-system/outreach_templates.md) |

## Opening line
[PERSONAL LINE — WRITE THIS YOURSELF after reading something they actually published]

## Body
Copy template #2 — Podcast pitch from seo-system/outreach_templates.md, then:
