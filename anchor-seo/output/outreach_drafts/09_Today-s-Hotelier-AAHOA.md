# OUTREACH DRAFT — Today's Hotelier (AAHOA)
**Status:** DRAFT — not sent. Kenny writes the personal line, verifies the contact, and sends manually.

| Field | Value |
|---|---|
| Site | https://www.todayshotelier.com |
| Category | Hospitality publication |
| Contact page | https://www.todayshotelier.com |
| Submission URL |  |
| Target page | https://anchorforhotels.com/ |
| Anchor (suggest only) | Anchor for Hotels |
| Pitch angle | Perfect audience (owner-operators); pitch bylined article on overnight coverage |
