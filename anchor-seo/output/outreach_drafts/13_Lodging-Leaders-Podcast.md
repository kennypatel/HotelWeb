# OUTREACH DRAFT — Lodging Leaders Podcast
**Status:** DRAFT — not sent. Kenny writes the personal line, verifies the contact, and sends manually.

| Field | Value |
|---|---|
| Site | https://lodgingleaders.com |
| Category | Podcast |
| Contact page | https://lodgingleaders.com/contact/ |
| Submission URL |  |
| Target page | https://anchorforhotels.com/ |
| Anchor (suggest only) | Anchor for Hotels |
| Pitch angle | Hotel investment/ops audience; pitch missed-call economics episode |
