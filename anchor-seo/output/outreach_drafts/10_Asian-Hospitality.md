# OUTREACH DRAFT — Asian Hospitality
**Status:** DRAFT — not sent. Kenny writes the personal line, verifies the contact, and sends manually.

| Field | Value |
|---|---|
| Site | https://www.asianhospitality.com |
| Category | Hospitality publication |
| Contact page | https://www.asianhospitality.com/contact/ |
| Submission URL |  |
| Target page | https://anchorforhotels.com/overnight-hotel-call-answering |
| Anchor (suggest only) | overnight hotel call answering |
| Pitch angle | Audience = AAHOA-segment owner-operators; pitch missed-call economics story |
